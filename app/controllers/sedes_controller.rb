...
layout 'barramenu'
  ...
  def create
    ...
    respond_to do |format|
      if @sede.save
        format.html { redirect_to @sede, notice: 'Un nuevo registro fue creado.' }
  ...
  def update
    respond_to do |format|
      if @sede.update(sede_params)
        format.html { redirect_to @sede, notice: 'El registro se actualizo.' }
  ...
  def destroy
    @sede.destroy
    respond_to do |format|
      format.html { redirect_to sedes_url, notice: 'El registro fue eliminado.' }
  ...
  private
    ...
    def sede_params
     params.require(:sede).permit(:sede_id, :ciudad, :departamento) #linea original 
     # params.permit(:sede_id, :ciudad, :departamento)
    end
end
